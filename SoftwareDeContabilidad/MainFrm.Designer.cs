namespace SoftwareDeContabilidad
{
    partial class MainFrm
    {
        ...
        private void InitializeComponent()
        {
            ...
            TreeNode treeNode2 = new TreeNode("Productos");
            TreeNode treeNode3 = new TreeNode("Facturas de ventas");
            TreeNode treeNode4 = new TreeNode("Facturas de compras");
            TreeNode treeNode5 = new TreeNode("Facturas", new TreeNode[] { treeNode3, treeNode4 });
            TreeNode treeNode6 = new TreeNode("Gastos");
            TreeNode treeNode7 = new TreeNode("Ingresos");
            TreeNode treeNode8 = new TreeNode("Pagos", new TreeNode[] { treeNode6, treeNode7 });
            TreeNode treeNode9 = new TreeNode("Resumen de gastos");
